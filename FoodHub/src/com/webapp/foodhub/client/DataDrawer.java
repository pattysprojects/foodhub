...
public class DataDrawer {
	...
	public void drawExploreData() {
		addDataToTable();
		// Set the height of the scrollpanel before attaching it
		resizeController.setExploreResultsHeight(scrollPanel.getElement());
		RootPanel.get("explore_results").add(scrollPanel);
	}
	
	public void drawSearchData() {
		addDataToTable();
		resizeController.setSearchResultsHeight(scrollPanel.getElement());
